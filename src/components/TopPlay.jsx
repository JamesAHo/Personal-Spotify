...
const TopPlay = () => {
  ...
  // get first five item from the object
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col mt-8">
        ...
        <Swiper slidesPerView="auto" spaceBetween={15} freeMode centeredSlides modules={[FreeMode]} centeredSlidesBounds className="mt-4">
            {topPlays?.map((song, i) => (
