  ...
  return (
    <>
      ...
      <div className="absolute md:hidden block top-6 right-3">
        {
          mobileMenu ? (<RiCloseLine  className="w-6 h-6 text-white mr-2" onClick={() => setMobileMenu(false)} />) : <HiOutlineMenu className="w-6 h-6 text-white mr-2" onClick={() => setMobileMenu(true)} />
        }
      </div>
      {/* Conditional div */}
